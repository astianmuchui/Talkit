...
class Sequel {
   ...
   protected function close_connection(){
      return mysqli_close(self::establish_connection($this->dbname));
   }
   protected function query($query){
      return $this->result = mysqli_query(self::establish_connection($this->dbname),$this->query);

   }
   protected function fetch_all_assoc($table){
   ...
   protected function fetch_newest($table,$number){
   ...
   protected function fetch_oldest($table,$number){
   ...
   protected function fetch_single($table,$id){
      $this->query = "";
